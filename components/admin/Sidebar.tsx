...
import { Home, Users, FileText, BarChart, PlusSquare, ChartBar, ListCheckIcon, PlusIcon, Calendar, CalendarPlus, BookOpen, X, DoorOpen } from 'lucide-react'
...
export function Sidebar({ isOpen = false, onClose, userRole = 'EMPLOYEE' }: SidebarProps) {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div className={cn(
        "bg-green-800 text-white w-64 space-y-6 py-7 px-2 fixed inset-y-0 left-0 z-50 transform transition-transform duration-300 ease-in-out",
