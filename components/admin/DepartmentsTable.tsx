    ...
    <>
      ...
      <AdminToolbar>
        ...
        <div className="flex gap-2 ml-auto">
          <Button variant="outline" size="icon" onClick={loadDepartments} title="Refresh records" disabled={loading} className="shrink-0 h-10 w-10">
        ...
        <table className={adminTableClassName()}>
          <thead>
            <tr className={adminTheadRowClass}>
              <th className={adminThClass}>Department name</th>
              <th className={adminThClass}>Manager</th>
              <th className={adminThClass}>Total employees</th>
